...
function Featured() {
  ...
  return (
    <div className="featured  my-10 px-[10rem] w-full">
      ...
      <div className="cardContainer grid grid-cols-1 sm:grid-cols-3 md:grid-cols-4 gap-10">
      {cards.map((card) => (
        <div key={card.id} className="card w-[300px] cursor-pointer active:ring" onClick={() => (alert(card.id))}>
          <img
